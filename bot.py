...
async def start(client, message):
    ...
    await message.reply_text("👋 Send any Terabox link\n\nI will download and send video.")
...
async def link_handler(client, message: Message):
    ...
    try:
        ...
        await client.send_video(chat_id=message.chat.id, video=file, caption="Downloaded by Bot", supports_streaming=True)
        os.remove(file)
        await msg.delete()
